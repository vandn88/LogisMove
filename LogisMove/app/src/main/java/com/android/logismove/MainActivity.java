...
public class MainActivity extends AppCompatActivity implements
    ...
    private static final long UPDATE_INTERVAL = 1000 * 60 * 2; //2 minute
    private static final long FASTEST_UPDATE_INTERVAL = 10000; // 1 minute
    /**
